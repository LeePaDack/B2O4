...
const Header = () => {
    ...
    const afterLoginNavigate = (number) => {
        switch(number){
            case 1: {loginMember ? navigate("/GoodsShop") : navigate("/Login")} break;
            case 2: {loginMember ? navigate("/GoodsDetail") : navigate("/Login")} break;
            case 3: {loginMember ? navigate("/LiveStreamingPage") : navigate("/Login")} break;
            case 4: {loginMember ? navigate("/boardPosting") : navigate("/Login")} break;
            case 5: {loginMember ? navigate("/mypage") : navigate("/Login")} break;
        }
