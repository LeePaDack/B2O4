const Footer = () => {
    return(
        ...
        <div className="footer-container">
            <div className="icon">
                <p>
                    <a className="footerLink" href="https://www.facebook.com/?locale=ko_KR"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-facebook" viewBox="0 0 16 16">
                    ...
                    <a className="footerLink" href="https://www.youtube.com/?hl=ko&gl=KR&app=desktop">
